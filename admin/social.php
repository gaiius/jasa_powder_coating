...
<legend>Social Activities
  </p>
</legend>
		<a href="?page=inputsocial">
...
<thead>
  ...
  <tr>
    ...
    <td align="center">
            ...
            <a href="hapussocial.php?id=<?php echo $data['id_kaizen'] ?>" onClick="return confirm('Apakah Anda Ingin Menghapus Ini ?');">
