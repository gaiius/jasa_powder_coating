...
<form action="simpaneditpost.php" method="post">
<table width="393" height="137" border="0" align="left">
  ...
  <input type="hidden" name="id_popular" value="<?php echo $data['id_popular'] ?>" required />
  <tr>
  ...
  <input type="hidden" name="tanggal_post" value="<?php echo $data['tanggal_post'] ?>" required />
  </table>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
