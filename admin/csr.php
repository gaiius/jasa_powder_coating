...
<legend>Data Berita
			...
			<a href="?page=inputcsr">
	<input type="button" value="+ Add CSR" class="box-title" />
    	</a>
    		<br/><br/>
		<div id="container">
		  <div class="box">
...
<thead>
  ...
  <tr>
    ...
    <td align="center">
			<a href="?page=detailcsr&id=<?php echo $data['id_berita'] ?>">
            <input type="button" value="View Detail" class="box" />
            </a>
            ---
            <a href="?page=editcsr&id=<?php echo $data['id_berita'] ?>">
            <input type="button" value="Edit" class="box" />
            </a>
            <a href="hapuscsr.php?id=<?php echo $data['id_berita'] ?>&amp;id_testimoni=<?php echo $data['id_testimoni'] ?>" onClick="return confirm('Apakah Anda Ingin Menghapus Berita Ini ?');">
