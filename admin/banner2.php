...
<legend>List Banner 2
  </p>
</legend>
			<a href="?page=inputbanner2">
...
<thead>
  ...
  $query=mysql_query("select * from banner2 ORDER BY id_banner
DESC LIMIT 10");
  ...
  <tr>
    ...
    <input type="button" value="View Detail" class="box" />
        ...
        <a href="hapusbanner2.php?id=<?php echo $data['id_banner'] ?>" onClick="return confirm('Apakah Anda Ingin Menghapus Banner Ini ?');">
