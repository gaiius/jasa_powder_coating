                ...
                <div class="box-content nopadding">
                    <table id="dt-example" cellpadding="0" cellspacing="0" border="0" class="table-dt table-striped-dt table-bordered-dt dataTable">
                        ...
                        <tbody>
                            ...
                            $query = mysql_query("select * from sejarah");
                            while ($data = mysql_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="?page=detailsejarah&id=<?php echo $data['id_sejarah'] ?>">
                                            <input type="button" value="View Detail" class="box" />
                                        </a>
                                        ---
                                        <a href="?page=editsejarah&id=<?php echo $data['id_sejarah'] ?>">
