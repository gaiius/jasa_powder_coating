...
<legend>TOP CUSTOMERS
  </p>
</legend>
			<a href="?page=input_gallery">
...
<thead>
  ...
  <tr>
    ...
    <td align="center"><?php echo $data['tgl_gambar'] ?></td>
    
    <td align="center">
			<a href="?page=detailgallery&id=<?php echo $data['id_gambar'] ?>">
            <input type="button" value="View Detail" class="box" />
            </a>
            ---
            <a href="?page=editgallery&id=<?php echo $data['id_gambar'] ?>">
            <input type="button" value="Edit" class="box" />
            </a>
            <a href="hapusgallery.php?id=<?php echo $data['id_gambar'] ?>&amp;id_testimoni=<?php echo $data['id_testimoni'] ?>" onClick="return confirm('Apakah Anda Ingin Menghapus Foto Ini ?');">
